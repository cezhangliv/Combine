...
do
	...
	do
		echo "iK = $iK"
        	...
        	mv robustHesse${CUTS}_iK${iK}_TOY${NTOY}.root ./HesseMatrix
		#remove the additional output file created by combine
        	rm multidimfit${CUTS}_iK${iK}_TOY${NTOY}.root
	done
