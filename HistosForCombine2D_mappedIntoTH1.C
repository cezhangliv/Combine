...
void HistosForCombine2D_mappedIntoTH1(int NTOY, TString angular_cuts) {
	...
	TString dirMSUp        = mainDir + range_folder + "job_MSUpTemplNEWNEWNEW_Ebeam150.000_xX00.0438702_IntrRes0.021/MuE/" + fileLocation;//templates with MS+1%
	...
	TString dirMSDown      = mainDir + range_folder + "job_MSDownTemplNEWNEWNEW_Ebeam150.000_xX00.0421498_IntrRes0.021/MuE/" + fileLocation;//templates with MS-1%
